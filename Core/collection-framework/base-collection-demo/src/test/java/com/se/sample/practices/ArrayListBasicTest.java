...
public class ArrayListBasicTest {
    ...
    private final List<String> inputStringList = Arrays.asList("hi", "hello", "goodmorning", "ass");
    private final List<String> actualStringList = Arrays.asList("goodmorning", "goodmorning", "goodmorning", "goodmorning");
