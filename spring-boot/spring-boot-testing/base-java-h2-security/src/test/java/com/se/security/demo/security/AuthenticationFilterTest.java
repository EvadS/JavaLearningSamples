...
class AuthenticationFilterTest {
    ...
    void shouldAuthenticate() throws IOException {
        UserCredentials credentials = new UserCredentials("user", "test", "role");
    ...
    void shouldAddHeaderForAuthenticatedUser() {
        ...
        String val = "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJuYW1lIiwiYXV0aG9yaXRpZXMiOlsidGVzdCJdLCJpYXQiOjk0NjY4MTIwMCwiZXhwIj" +
