...
import com.se.sample.multipledatabases.repository.CustomerRepository;
...
public class MultipleDatabasesApplication {
    ...
    private static final Logger log = LoggerFactory.getLogger(MultipleDatabasesApplication.class);
