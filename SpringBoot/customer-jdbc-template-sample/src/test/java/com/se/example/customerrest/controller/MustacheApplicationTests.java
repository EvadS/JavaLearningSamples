...
public class MustacheApplicationTests {
    ...
    public void testMainPage() throws Exception {
        ...
        ResponseEntity<String> entity = this.restTemplate.getForEntity("/welcome/title", String.class);
    ...
    public void test5xxPage() throws Exception {
        ...
        headers.setAccept(Arrays.asList(MediaType.TEXT_HTML));
        HttpEntity<String> requestEntity = new HttpEntity<String>(headers);
        ResponseEntity<String> responseEntity = this.restTemplate.exchange("/welcome/5xx", HttpMethod.GET, requestEntity,
                String.class);
