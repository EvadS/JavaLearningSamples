...
import com.se.example.springboot_validation.SpringbootValidationApplication;
...
@RunWith(SpringRunner.class)
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT/*, classes = SpringbootValidationApplication.class*/)
